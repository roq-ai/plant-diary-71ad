...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Journals', path: '/journals', entity: 'journal', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Materials', path: '/materials', entity: 'material', service: AccessServiceEnum.PROJECT, icon: FiLink },
    { name: 'Plantings', path: '/plantings', entity: 'planting', service: AccessServiceEnum.PROJECT, icon: FiFeather },
